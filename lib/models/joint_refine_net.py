...
class JointRefineNet(nn.Module):
    def __init__(self, cfg):
        ...
        self.v2v_net = V2VNetLite(cfg.NETWORK.NUM_JOINTS_WHOLEBODY, cfg.NETWORK.NUM_JOINTS_WHOLEBODY)
    ...
    def forward(self, all_heatmaps_whole, meta, grid_centers, all_cloud=None):
        ...
        face_joint_index_list = [0] + [i for i in range(13,13+68)]
        ...
        pred_face = self.soft_argmax_layer(valid_cubes[:, face_joint_index_list, ...], grids_face)
